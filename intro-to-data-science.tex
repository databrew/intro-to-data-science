...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{which}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(vehicles}\OperatorTok{$}\NormalTok{hwy))}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'vehicles'}\NormalTok{ not found}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{which}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(vehicles}\OperatorTok{$}\NormalTok{cyl))}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'vehicles'}\NormalTok{ not found}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{mean}\NormalTok{(vehicles}\OperatorTok{$}\NormalTok{cty)}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'vehicles'}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{is.data.frame}\NormalTok{(x)}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'vehicles'}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{str}\NormalTok{(vehicles}\OperatorTok{$}\NormalTok{make)}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'vehicles'}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{summary}\NormalTok{(vehicles)}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'vehicles'}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{unique}\NormalTok{(vehicles}\OperatorTok{$}\NormalTok{fuel)}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'vehicles'}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{head}\NormalTok{(vehicles_sorted)}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'vehicles_sorted'}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{library}\NormalTok{(DescTools)}\OperatorTok{:}\StringTok{ }\NormalTok{there is no package called }\StringTok{'DescTools'}
\KeywordTok{MeanCI}\NormalTok{(df}\OperatorTok{$}\NormalTok{price)}
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{MeanCI}\NormalTok{(df}\OperatorTok{$}\NormalTok{price)}\OperatorTok{:}\StringTok{ }\NormalTok{could not find }\ControlFlowTok{function} \StringTok{"MeanCI"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{geocode}\NormalTok{(., addr, }\DataTypeTok{method =} \StringTok{"osm"}\NormalTok{, }\DataTypeTok{lat =}\NormalTok{ latitude, }\DataTypeTok{long =}\NormalTok{ longitude)}\OperatorTok{:}\StringTok{ }\NormalTok{could not find }\ControlFlowTok{function} \StringTok{"geocode"}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{lat_longs}
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{eval}\NormalTok{(expr, envir, enclos)}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'lat_longs'}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{structure}\NormalTok{(}\KeywordTok{list}\NormalTok{(}\DataTypeTok{options =}\NormalTok{ options), }\DataTypeTok{leafletData =}\NormalTok{ data)}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'lat_longs'}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{reverse_geocode}\NormalTok{(., }\DataTypeTok{lat =}\NormalTok{ latitude, }\DataTypeTok{long =}\NormalTok{ longitude)}\OperatorTok{:}\StringTok{ }\NormalTok{could not find }\ControlFlowTok{function} \StringTok{"reverse_geocode"}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{reverse}
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{eval}\NormalTok{(expr, envir, enclos)}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'reverse'}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{is.factor}\NormalTok{(x)}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'reverse'}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{words <-}\StringTok{ }\NormalTok{survey }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{select}\NormalTok{(first_name,}
\NormalTok{                feeling_num,}
\NormalTok{                feeling) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{unnest_tokens}\NormalTok{(word, feeling)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{1655463297}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pkgs <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'tigris'}\NormalTok{, }\StringTok{'dplyr'}\NormalTok{, }\StringTok{'readr'}\NormalTok{, }\StringTok{'ggplot2'}\NormalTok{, }\StringTok{'leaflet'}\NormalTok{, }\StringTok{'rgdal'}\NormalTok{, }\StringTok{'raster'}\NormalTok{, }\StringTok{'sp'}\NormalTok{, }\StringTok{'rasterVis'}\NormalTok{,}
          \StringTok{'htmltools'}\NormalTok{, }\StringTok{'RColorBrewer'}\NormalTok{, }\StringTok{'leaflet.extras'}\NormalTok{, }\StringTok{'geosphere'}\NormalTok{)}
...
\addcontentsline{toc}{subsection}{Some learning exercises with Tennessee zip codes}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tng <-}\StringTok{ }\KeywordTok{fortify}\NormalTok{(tnz, }\DataTypeTok{region =} \StringTok{'GEOID20'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{zip =}\NormalTok{ id)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{map_palette <-}\StringTok{ }\KeywordTok{colorNumeric}\NormalTok{(}\DataTypeTok{palette =} \KeywordTok{brewer.pal}\NormalTok{(}\DecValTok{9}\NormalTok{, }\StringTok{"Greens"}\NormalTok{), }
                            \DataTypeTok{domain=}\NormalTok{tnz}\OperatorTok{@}\NormalTok{data}\OperatorTok{$}\NormalTok{pop, }
...
\StringTok{  }\KeywordTok{addTiles}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{addPolygons}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ tnz, }\DataTypeTok{fillColor =} \OperatorTok{~}\KeywordTok{map_palette}\NormalTok{(pop),}
                             ...
                             \DataTypeTok{label =} \OperatorTok{~}\NormalTok{pop)}
\NormalTok{Error }\ControlFlowTok{in} \KeywordTok{eval}\NormalTok{(f[[}\DecValTok{2}\NormalTok{]], }\KeywordTok{metaData}\NormalTok{(data), }\KeywordTok{environment}\NormalTok{(f))}\OperatorTok{:}\StringTok{ }\NormalTok{object }\StringTok{'pop'}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{tnz}\OperatorTok{@}\NormalTok{data}\OperatorTok{$}\NormalTok{km <-}\StringTok{ }\NormalTok{km[}\DecValTok{1}\NormalTok{,]}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{figures/unnamed-chunk-663-1.pdf}
...
\includegraphics{figures/unnamed-chunk-684-1.pdf}
...
\includegraphics{figures/unnamed-chunk-694-1.pdf}
...
\includegraphics{figures/unnamed-chunk-695-1.pdf}
...
\includegraphics{figures/unnamed-chunk-700-1.pdf}
