...
\includegraphics{img/vis4.png}

\includegraphics{img/vis5.jpg}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"\_C+]o\#80F\^{}6r[Scgt3E\textquotesingle{}kH|\textgreater{}"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"IehSO\%u+,Rs \_3i\&vTVtbJ5\textquotesingle{}"}
\end{Highlighting}
\end{Shaded}
