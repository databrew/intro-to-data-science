...
\tightlist
\item
  Alternatively, no Mac, you can download Xcode from the Mac App Store correctly: \url{https://apps.apple.com/ca/app/xcode/id497799835?mt=12}
\end{itemize}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{3} \DecValTok{9} \DecValTok{5}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{]   }\DecValTok{6} \DecValTok{992}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  [}\DecValTok{1}\NormalTok{]  }\ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}
\NormalTok{ [}\DecValTok{13}\NormalTok{]  }\ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}
\NormalTok{ [}\DecValTok{25}\NormalTok{]  }\ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}
...
\NormalTok{ [}\DecValTok{49}\NormalTok{]  }\ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}
...
\NormalTok{ [}\DecValTok{73}\NormalTok{]  }\ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE} \ConstantTok{FALSE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}  \ConstantTok{TRUE}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\DecValTok{427} \DecValTok{944} \DecValTok{211} \DecValTok{185} \DecValTok{780} \DecValTok{781} \DecValTok{106} \DecValTok{132} \DecValTok{301} \DecValTok{982} \DecValTok{723} \DecValTok{807} \DecValTok{599} \DecValTok{873} \DecValTok{595} \DecValTok{375} \DecValTok{947} \DecValTok{660} \DecValTok{522}
\NormalTok{[}\DecValTok{20}\NormalTok{] }\DecValTok{411} \DecValTok{811} \DecValTok{724} \DecValTok{469} \DecValTok{309} \DecValTok{756} \DecValTok{230} \DecValTok{731} \DecValTok{508} \DecValTok{531} \DecValTok{209} \DecValTok{821} \DecValTok{719} \DecValTok{358} \DecValTok{955} \DecValTok{923} \DecValTok{916} \DecValTok{663} \DecValTok{503}
\NormalTok{[}\DecValTok{39}\NormalTok{] }\DecValTok{925} \DecValTok{450} \DecValTok{572} \DecValTok{269} \DecValTok{649} \DecValTok{608} \DecValTok{500} \DecValTok{992} \DecValTok{768} \DecValTok{303} \DecValTok{153} \DecValTok{478}  \DecValTok{98} \DecValTok{820} \DecValTok{394} \DecValTok{881} \DecValTok{446} \DecValTok{574} \DecValTok{162}
\NormalTok{[}\DecValTok{58}\NormalTok{] }\DecValTok{231} \DecValTok{136} \DecValTok{327} \DecValTok{622} \DecValTok{846} \DecValTok{927} \DecValTok{883} \DecValTok{117} \DecValTok{867} \DecValTok{620} \DecValTok{257} \DecValTok{835} \DecValTok{890} \DecValTok{101} \DecValTok{782} \DecValTok{924} \DecValTok{297} \DecValTok{128} \DecValTok{380}
\NormalTok{[}\DecValTok{77}\NormalTok{] }\DecValTok{887} \DecValTok{319} \DecValTok{804} \DecValTok{318} \DecValTok{975} \DecValTok{176} \DecValTok{896} \DecValTok{352} \DecValTok{918} \DecValTok{948} \DecValTok{384} \DecValTok{223} \DecValTok{313} \DecValTok{940} \DecValTok{377} \DecValTok{170} \DecValTok{438} \DecValTok{921}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{y[verdicts]}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{80} \DecValTok{76}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{library}\NormalTok{(fueleconomy)}\SpecialCharTok{:}\NormalTok{ there is no package called }\StringTok{\textquotesingle{}fueleconomy\textquotesingle{}}
\FunctionTok{data}\NormalTok{(vehicles)}
\FunctionTok{head}\NormalTok{(vehicles)}
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{head}\NormalTok{(vehicles)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}vehicles\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{tail}\NormalTok{(vehicles)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}vehicles\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{eval}\NormalTok{(expr, envir, enclos)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}vehicles\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{nrow}\NormalTok{(vehicles)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}vehicles\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{ncol}\NormalTok{(vehicles)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}vehicles\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{which}\NormalTok{(}\FunctionTok{is.na}\NormalTok{(vehicles}\SpecialCharTok{$}\NormalTok{hwy))}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}vehicles\textquotesingle{}}\NormalTok{ not found}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{which}\NormalTok{(}\FunctionTok{is.na}\NormalTok{(vehicles}\SpecialCharTok{$}\NormalTok{cyl))}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}vehicles\textquotesingle{}}\NormalTok{ not found}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{mean}\NormalTok{(vehicles}\SpecialCharTok{$}\NormalTok{cty)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}vehicles\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{is.data.frame}\NormalTok{(x)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}vehicles\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{str}\NormalTok{(vehicles}\SpecialCharTok{$}\NormalTok{make)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}vehicles\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{summary}\NormalTok{(vehicles)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}vehicles\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{unique}\NormalTok{(vehicles}\SpecialCharTok{$}\NormalTok{fuel)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}vehicles\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{head}\NormalTok{(vehicles\_sorted)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}vehicles\_sorted\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{as.data.frame}\NormalTok{(vehicles)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}vehicles\textquotesingle{}}\NormalTok{ not found}
\NormalTok{df[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{,}\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{]}
\NormalTok{Error }\ControlFlowTok{in} \StringTok{\textasciigrave{}}\AttributeTok{[.data.frame}\StringTok{\textasciigrave{}}\NormalTok{(df, }\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{, }\DecValTok{1}\SpecialCharTok{:}\DecValTok{4}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ undefined columns selected}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{library}\NormalTok{(ggthemes)}\SpecialCharTok{:}\NormalTok{ there is no package called }\StringTok{\textquotesingle{}ggthemes\textquotesingle{}}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{theme\_economist\_white}\NormalTok{()}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"theme\_economist\_white"}
\NormalTok{p}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{library}\NormalTok{(DescTools)}\SpecialCharTok{:}\NormalTok{ there is no package called }\StringTok{\textquotesingle{}DescTools\textquotesingle{}}
\FunctionTok{MeanCI}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{price)}
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{MeanCI}\NormalTok{(df}\SpecialCharTok{$}\NormalTok{price)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"MeanCI"}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{figures/unnamed-chunk-392-1.pdf}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{library}\NormalTok{(tidygeocoder)}\SpecialCharTok{:}\NormalTok{ there is no package called }\StringTok{\textquotesingle{}tidygeocoder\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{geocode}\NormalTok{(., addr, }\AttributeTok{method =} \StringTok{"osm"}\NormalTok{, }\AttributeTok{lat =}\NormalTok{ latitude, }\AttributeTok{long =}\NormalTok{ longitude)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"geocode"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{eval}\NormalTok{(expr, envir, enclos)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}lat\_longs\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{structure}\NormalTok{(}\FunctionTok{list}\NormalTok{(}\AttributeTok{options =}\NormalTok{ options), }\AttributeTok{leafletData =}\NormalTok{ data)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}lat\_longs\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{reverse\_geocode}\NormalTok{(., }\AttributeTok{lat =}\NormalTok{ latitude, }\AttributeTok{long =}\NormalTok{ longitude)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"reverse\_geocode"}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{reverse}
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{eval}\NormalTok{(expr, envir, enclos)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}reverse\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{is.factor}\NormalTok{(x)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}reverse\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{head}\NormalTok{(babynames)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}babynames\textquotesingle{}}\NormalTok{ not found}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{eval}\NormalTok{(m}\SpecialCharTok{$}\NormalTok{data, eframe)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}baracks\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{gsheet2tbl}\NormalTok{(}\StringTok{"https://docs.google.com/spreadsheets/d/1iVt9FX9J2iv3QFKBM7Gzb9dgva70XrW1lxMV4hpekeo/edit?resourcekey\#gid=204634767"}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"gsheet2tbl"}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
Error in names(survey) <- c("time", "sex", "age", "sib", "dad_mus", "person_mus", : object 'survey' not found
\end{verbatim}
...
\NormalTok{ Date[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{1}\NormalTok{], format}\SpecialCharTok{:} \StringTok{"2022{-}05{-}27"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{today }\SpecialCharTok{{-}}\NormalTok{ my\_birthday}
\NormalTok{Time difference of }\DecValTok{13350}\NormalTok{ days}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{n}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2022{-}05{-}27 18:32:27 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2022{-}05{-}27 18:32:28 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2022{-}05{-}27 13:32:27 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2022{-}05{-}27"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2022{-}05{-}28"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2022{-}05{-}27 23:32:27 UTC"}

\FunctionTok{now}\NormalTok{(}\StringTok{\textquotesingle{}GMT\textquotesingle{}}\NormalTok{)}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2022{-}05{-}27 23:32:27 GMT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2022{-}05{-}27 23:32:27 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{1653694348}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{library}\NormalTok{(rgdal)}\SpecialCharTok{:}\NormalTok{ there is no package called }\StringTok{\textquotesingle{}rgdal\textquotesingle{}}
\FunctionTok{library}\NormalTok{(raster)}
\FunctionTok{library}\NormalTok{(sp)}
\FunctionTok{library}\NormalTok{(rasterVis)}
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{library}\NormalTok{(rasterVis)}\SpecialCharTok{:}\NormalTok{ there is no package called }\StringTok{\textquotesingle{}rasterVis\textquotesingle{}}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{.rasterObjectFromFile}\NormalTok{(x, }\AttributeTok{band =}\NormalTok{ band, }\AttributeTok{objecttype =} \StringTok{"RasterLayer"}\NormalTok{, }\SpecialCharTok{:}\NormalTok{ Cannot create RasterLayer object from this file; perhaps you need to install rgdal first}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{h}\NormalTok{(}\FunctionTok{simpleError}\NormalTok{(msg, call))}\SpecialCharTok{:}\NormalTok{ error }\ControlFlowTok{in}\NormalTok{ evaluating the argument }\StringTok{\textquotesingle{}x\textquotesingle{}} \ControlFlowTok{in}\NormalTok{ selecting a method }\ControlFlowTok{for} \ControlFlowTok{function} \StringTok{\textquotesingle{}plot\textquotesingle{}}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}elevation\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{h}\NormalTok{(}\FunctionTok{simpleError}\NormalTok{(msg, call))}\SpecialCharTok{:}\NormalTok{ error }\ControlFlowTok{in}\NormalTok{ evaluating the argument }\StringTok{\textquotesingle{}x\textquotesingle{}} \ControlFlowTok{in}\NormalTok{ selecting a method }\ControlFlowTok{for} \ControlFlowTok{function} \StringTok{\textquotesingle{}head\textquotesingle{}}\SpecialCharTok{:}\NormalTok{ error }\ControlFlowTok{in}\NormalTok{ evaluating the argument }\StringTok{\textquotesingle{}obj\textquotesingle{}} \ControlFlowTok{in}\NormalTok{ selecting a method }\ControlFlowTok{for} \ControlFlowTok{function} \StringTok{\textquotesingle{}coordinates\textquotesingle{}}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}elevation\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{h}\NormalTok{(}\FunctionTok{simpleError}\NormalTok{(msg, call))}\SpecialCharTok{:}\NormalTok{ error }\ControlFlowTok{in}\NormalTok{ evaluating the argument }\StringTok{\textquotesingle{}obj\textquotesingle{}} \ControlFlowTok{in}\NormalTok{ selecting a method }\ControlFlowTok{for} \ControlFlowTok{function} \StringTok{\textquotesingle{}proj4string\textquotesingle{}}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}elevation\textquotesingle{}}\NormalTok{ not found}

\FunctionTok{proj4string}\NormalTok{(tn)}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"+proj=longlat +datum=WGS84"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{.requireRgdal}\NormalTok{()}\SpecialCharTok{:}\NormalTok{ package }\StringTok{\textquotesingle{}rgdal\textquotesingle{}}\NormalTok{ is not available}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{h}\NormalTok{(}\FunctionTok{simpleError}\NormalTok{(msg, call))}\SpecialCharTok{:}\NormalTok{ error }\ControlFlowTok{in}\NormalTok{ evaluating the argument }\StringTok{\textquotesingle{}x\textquotesingle{}} \ControlFlowTok{in}\NormalTok{ selecting a method }\ControlFlowTok{for} \ControlFlowTok{function} \StringTok{\textquotesingle{}plot\textquotesingle{}}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}elevation\_ll\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{readOGR}\NormalTok{(destination\_directory, }\StringTok{"Boundary2016"}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"readOGR"}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{readOGR}\NormalTok{(destination\_directory, }\StringTok{"Domain\_Structures"}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"readOGR"}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{readOGR}\NormalTok{(destination\_directory, }\StringTok{"Roads"}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"readOGR"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{h}\NormalTok{(}\FunctionTok{simpleError}\NormalTok{(msg, call))}\SpecialCharTok{:}\NormalTok{ error }\ControlFlowTok{in}\NormalTok{ evaluating the argument }\StringTok{\textquotesingle{}x\textquotesingle{}} \ControlFlowTok{in}\NormalTok{ selecting a method }\ControlFlowTok{for} \ControlFlowTok{function} \StringTok{\textquotesingle{}plot\textquotesingle{}}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}boundary\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{h}\NormalTok{(}\FunctionTok{simpleError}\NormalTok{(msg, call))}\SpecialCharTok{:}\NormalTok{ error }\ControlFlowTok{in}\NormalTok{ evaluating the argument }\StringTok{\textquotesingle{}x\textquotesingle{}} \ControlFlowTok{in}\NormalTok{ selecting a method }\ControlFlowTok{for} \ControlFlowTok{function} \StringTok{\textquotesingle{}spTransform\textquotesingle{}}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}boundary\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{h}\NormalTok{(}\FunctionTok{simpleError}\NormalTok{(msg, call))}\SpecialCharTok{:}\NormalTok{ error }\ControlFlowTok{in}\NormalTok{ evaluating the argument }\StringTok{\textquotesingle{}x\textquotesingle{}} \ControlFlowTok{in}\NormalTok{ selecting a method }\ControlFlowTok{for} \ControlFlowTok{function} \StringTok{\textquotesingle{}plot\textquotesingle{}}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}boundary\_ll\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'crop': object 'elevation_ll' not found
Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'mask': object 'domain_elev' not found
Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'plot': object 'domain_elev' not found
\end{verbatim}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{loadNamespace}\NormalTok{(x)}\SpecialCharTok{:}\NormalTok{ there is no package called }\StringTok{\textquotesingle{}rasterVis\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'spTransform': object 'roads' not found
Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'plot': object 'domain_elev' not found
Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'plot': object 'roads_ll' not found
\end{verbatim}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{h}\NormalTok{(}\FunctionTok{simpleError}\NormalTok{(msg, call))}\SpecialCharTok{:}\NormalTok{ error }\ControlFlowTok{in}\NormalTok{ evaluating the argument }\StringTok{\textquotesingle{}x\textquotesingle{}} \ControlFlowTok{in}\NormalTok{ selecting a method }\ControlFlowTok{for} \ControlFlowTok{function} \StringTok{\textquotesingle{}over\textquotesingle{}}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}roads\_ll\textquotesingle{}}\NormalTok{ not found}
\NormalTok{roads\_ll\_trim }\OtherTok{\textless{}{-}}\NormalTok{ roads\_ll[}\SpecialCharTok{!}\FunctionTok{is.na}\NormalTok{(o),]}
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{eval}\NormalTok{(expr, envir, enclos)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}roads\_ll\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{h}\NormalTok{(}\FunctionTok{simpleError}\NormalTok{(msg, call))}\SpecialCharTok{:}\NormalTok{ error }\ControlFlowTok{in}\NormalTok{ evaluating the argument }\StringTok{\textquotesingle{}x\textquotesingle{}} \ControlFlowTok{in}\NormalTok{ selecting a method }\ControlFlowTok{for} \ControlFlowTok{function} \StringTok{\textquotesingle{}plot\textquotesingle{}}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}domain\_elev\textquotesingle{}}\NormalTok{ not found}
\FunctionTok{plot}\NormalTok{(roads\_ll\_trim, }\AttributeTok{add =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{h}\NormalTok{(}\FunctionTok{simpleError}\NormalTok{(msg, call))}\SpecialCharTok{:}\NormalTok{ error }\ControlFlowTok{in}\NormalTok{ evaluating the argument }\StringTok{\textquotesingle{}x\textquotesingle{}} \ControlFlowTok{in}\NormalTok{ selecting a method }\ControlFlowTok{for} \ControlFlowTok{function} \StringTok{\textquotesingle{}plot\textquotesingle{}}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}roads\_ll\_trim\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{h}\NormalTok{(}\FunctionTok{simpleError}\NormalTok{(msg, call))}\SpecialCharTok{:}\NormalTok{ error }\ControlFlowTok{in}\NormalTok{ evaluating the argument }\StringTok{\textquotesingle{}x\textquotesingle{}} \ControlFlowTok{in}\NormalTok{ selecting a method }\ControlFlowTok{for} \ControlFlowTok{function} \StringTok{\textquotesingle{}values\textquotesingle{}}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}elevation\_ll\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
Error in readOGR(file.path(destination_directory, "world_small/"), "TM_WORLD_BORDERS_SIMPL-0.3"): could not find function "readOGR"
Error in save(world_shp, file = "data/world_shp.RData"): object 'world_shp' not found
\end{verbatim}
...
\includegraphics{figures/unnamed-chunk-647-1.pdf}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{library}\NormalTok{(truncnorm)}\SpecialCharTok{:}\NormalTok{ there is no package called }\StringTok{\textquotesingle{}truncnorm\textquotesingle{}}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{rtruncnorm}\NormalTok{(}\AttributeTok{n =} \DecValTok{25}\NormalTok{, }\AttributeTok{a =} \DecValTok{0}\NormalTok{, }\AttributeTok{mean =} \FloatTok{3.6}\NormalTok{, }\AttributeTok{sd =} \DecValTok{3}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ could not find }\ControlFlowTok{function} \StringTok{"rtruncnorm"}
\NormalTok{n2021}
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{eval}\NormalTok{(expr, envir, enclos)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}n2021\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{eval}\NormalTok{(predvars, data, env)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}n2021\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{sample}\NormalTok{(n2021, }\AttributeTok{size =} \DecValTok{10000}\NormalTok{, }\AttributeTok{replace =} \ConstantTok{TRUE}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}n2021\textquotesingle{}}\NormalTok{ not found}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{eval}\NormalTok{(expr, envir, enclos)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}r2021\textquotesingle{}}\NormalTok{ not found}
...
\FunctionTok{hist}\NormalTok{(diffs,}\AttributeTok{breaks=}\FunctionTok{seq}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{20}\NormalTok{,}\DecValTok{20}\NormalTok{,}\AttributeTok{by=}\DecValTok{1}\NormalTok{),}\AttributeTok{xlim=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{20}\NormalTok{,}\DecValTok{20}\NormalTok{),}
     \AttributeTok{main=}\ConstantTok{NULL}\NormalTok{,}\AttributeTok{xlab=}\StringTok{"Null distribution"}\NormalTok{,}\AttributeTok{border=}\StringTok{"grey70"}\NormalTok{)}
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{hist.default}\NormalTok{(diffs, }\AttributeTok{breaks =} \FunctionTok{seq}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{20}\NormalTok{, }\DecValTok{20}\NormalTok{, }\AttributeTok{by =} \DecValTok{1}\NormalTok{), }\AttributeTok{xlim =} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{20}\NormalTok{, }\SpecialCharTok{:}\NormalTok{ some }\StringTok{\textquotesingle{}x\textquotesingle{}}\NormalTok{ not counted; maybe }\StringTok{\textquotesingle{}breaks\textquotesingle{}}\NormalTok{ do not span range of }\StringTok{\textquotesingle{}x\textquotesingle{}}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{int\_abline}\NormalTok{(}\AttributeTok{a =}\NormalTok{ a, }\AttributeTok{b =}\NormalTok{ b, }\AttributeTok{h =}\NormalTok{ h, }\AttributeTok{v =}\NormalTok{ v, }\AttributeTok{untf =}\NormalTok{ untf, ...)}\SpecialCharTok{:}\NormalTok{ plot.new has not been called yet}
