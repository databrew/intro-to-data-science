...
First, read in some cool data ([link to dataset](https://github.com/databrew/intro-to-data-science/blob/main/data/keeling-curve.csv?raw=true)).
...
Your data ([link to dataset](https://github.com/databrew/intro-to-data-science/blob/main/nz_birds.csv?raw=true)) look like this: 
...
First, read in and format some other cool data ([link to dataset](https://github.com/databrew/intro-to-data-science/blob/main/data/renewable_energy.csv?raw=true)). The code for doing so is provided for you here:
