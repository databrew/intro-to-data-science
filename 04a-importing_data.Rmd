...
You can use this simple data file, [`super_data.csv`](https://github.com/databrew/intro-to-data-science/blob/main/super_data.csv?raw=true), to practice.


```{r,echo=FALSE,eval=FALSE}
library(downloadthis)
download_link(
  link = "https://github.com/databrew/intro-to-data-science/blob/main/super_data.csv?raw=true",
...
For example, [`super_data.rds`](https://github.com/databrew/intro-to-data-science/blob/main/super_data.rds?raw=true) contains a `tibble` version of the dataframe above. When you read in that `.rds` file, it is already formatted as a `tibble`: 
