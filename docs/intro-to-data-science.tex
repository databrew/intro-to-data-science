...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{1} \DecValTok{5} \DecValTok{3}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{]   }\DecValTok{2} \DecValTok{991}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ [}\DecValTok{13}\NormalTok{]  }\OtherTok{TRUE} \OtherTok{FALSE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}
\NormalTok{ [}\DecValTok{25}\NormalTok{] }\OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}
...
\NormalTok{ [}\DecValTok{49}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}
\NormalTok{ [}\DecValTok{61}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}
\NormalTok{ [}\DecValTok{73}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}
\NormalTok{ [}\DecValTok{85}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}
\NormalTok{ [}\DecValTok{97}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\DecValTok{968} \DecValTok{602} \DecValTok{151} \DecValTok{294} \DecValTok{224} \DecValTok{242} \DecValTok{205} \DecValTok{883} \DecValTok{264} \DecValTok{610} \DecValTok{743} \DecValTok{846} \DecValTok{200} \DecValTok{617} \DecValTok{420} \DecValTok{963} \DecValTok{145} \DecValTok{679} \DecValTok{842}
\NormalTok{[}\DecValTok{20}\NormalTok{] }\DecValTok{440} \DecValTok{336} \DecValTok{538} \DecValTok{269} \DecValTok{720} \DecValTok{142} \DecValTok{622} \DecValTok{853} \DecValTok{104} \DecValTok{266} \DecValTok{394} \DecValTok{940} \DecValTok{365} \DecValTok{880} \DecValTok{823} \DecValTok{335} \DecValTok{947} \DecValTok{339} \DecValTok{745}
\NormalTok{[}\DecValTok{39}\NormalTok{] }\DecValTok{695} \DecValTok{285} \DecValTok{752} \DecValTok{193} \DecValTok{854} \DecValTok{604} \DecValTok{329} \DecValTok{599} \DecValTok{768} \DecValTok{100} \DecValTok{892} \DecValTok{861} \DecValTok{341} \DecValTok{895} \DecValTok{659} \DecValTok{938} \DecValTok{691} \DecValTok{522} \DecValTok{718}
\NormalTok{[}\DecValTok{58}\NormalTok{] }\DecValTok{633} \DecValTok{532} \DecValTok{980} \DecValTok{917} \DecValTok{537} \DecValTok{352} \DecValTok{240} \DecValTok{290} \DecValTok{250} \DecValTok{910} \DecValTok{988} \DecValTok{730} \DecValTok{395} \DecValTok{399} \DecValTok{767} \DecValTok{790} \DecValTok{459} \DecValTok{208} \DecValTok{664}
\NormalTok{[}\DecValTok{77}\NormalTok{] }\DecValTok{565} \DecValTok{301} \DecValTok{857} \DecValTok{504} \DecValTok{496} \DecValTok{473} \DecValTok{128} \DecValTok{933} \DecValTok{715} \DecValTok{356} \DecValTok{991}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"e}\CharTok{\textbackslash{}"}\StringTok{&~_nj8I142|HbRWd<YJS)E"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"L=%r~EioI:jZsk?l/5t$zu1N"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pd <-}\StringTok{ }\NormalTok{gm }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(country }\OperatorTok{%in%}\StringTok{ }\NormalTok{cn)}
 \KeywordTok{ggplot}\NormalTok{(pd, }\KeywordTok{aes_string}\NormalTok{(}\StringTok{'year'}\NormalTok{, pv, }\DataTypeTok{group=}\StringTok{'country'}\NormalTok{)) }\OperatorTok{+}
\StringTok{        }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{color =}\NormalTok{ pc, }\DataTypeTok{size =}\NormalTok{ ps, }\DataTypeTok{alpha=}\NormalTok{av) }\OperatorTok{+}
\StringTok{        }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{color =}\NormalTok{ lc, }\DataTypeTok{size =}\NormalTok{ ls, }\DataTypeTok{alpha=}\NormalTok{av) }\OperatorTok{+}
\StringTok{        }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =}\NormalTok{ cn)}
\end{Highlighting}
...
\NormalTok{        pv <-}\StringTok{ }\NormalTok{input}\OperatorTok{$}\NormalTok{plot_var}
\NormalTok{        pd <-}\StringTok{ }\NormalTok{gm }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(country }\OperatorTok{==}\StringTok{ }\NormalTok{cn)}
        \KeywordTok{ggplot}\NormalTok{(pd, }\KeywordTok{aes_string}\NormalTok{(}\StringTok{'year'}\NormalTok{, pv, }\DataTypeTok{color=}\StringTok{'country'}\NormalTok{)) }\OperatorTok{+}
\StringTok{            }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{size =}\NormalTok{ ps, }\DataTypeTok{alpha=}\NormalTok{av) }\OperatorTok{+}
\StringTok{            }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{size =}\NormalTok{ ls, }\DataTypeTok{alpha=}\NormalTok{av) }\OperatorTok{+}
\StringTok{            }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title =}\NormalTok{ cn)}
\NormalTok{    \})}
\NormalTok{\}}
...
\StringTok{    }\KeywordTok{addMarkers}\NormalTok{(}\DataTypeTok{data=}\NormalTok{sewanee)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{leaflet}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{addProviderTiles}\NormalTok{(providers}\OperatorTok{$}\NormalTok{Esri.WorldImagery) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{addMarkers}\NormalTok{(}\DataTypeTok{data=}\NormalTok{sewanee)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{leaflet}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{addProviderTiles}\NormalTok{(providers}\OperatorTok{$}\NormalTok{Esri.WorldTopoMap) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{addMarkers}\NormalTok{(}\DataTypeTok{data=}\NormalTok{sewanee)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{leaflet}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{addProviderTiles}\NormalTok{(providers}\OperatorTok{$}\NormalTok{Esri.WorldTopoMap) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{addCircleMarkers}\NormalTok{(}\DataTypeTok{data=}\NormalTok{sewanee, }
                     \DataTypeTok{color =} \StringTok{"firebrick"}\NormalTok{,}
                     \DataTypeTok{radius =} \DecValTok{15}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{    }\KeywordTok{addCircleMarkers}\NormalTok{(}\DataTypeTok{data=}\NormalTok{sewanee, }
                     \DataTypeTok{color =} \StringTok{"firebrick"}\NormalTok{,}
                     \DataTypeTok{radius =} \DecValTok{15}\NormalTok{,}
                     \DataTypeTok{popup =} \KeywordTok{paste0}\NormalTok{(}\StringTok{'<b>YSR, yall.</b> <br>'}\NormalTok{, }
                                    \StringTok{'Lat: '}\NormalTok{,sewanee}\OperatorTok{$}\NormalTok{longitude,}\StringTok{'<br>'}\NormalTok{,}
                                    \StringTok{'Lon: '}\NormalTok{,sewanee}\OperatorTok{$}\NormalTok{latitude,}\StringTok{'}\CharTok{\textbackslash{}n}\StringTok{'}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{leaflet}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{addProviderTiles}\NormalTok{(providers}\OperatorTok{$}\NormalTok{Esri.OceanBasemap) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{fitBounds}\NormalTok{(}\DataTypeTok{lng1 =} \DecValTok{-165}\NormalTok{,}
              \DataTypeTok{lng2 =} \DecValTok{-100}\NormalTok{,}
              \DataTypeTok{lat1 =} \DecValTok{10}\NormalTok{,}
              \DataTypeTok{lat2 =} \DecValTok{50}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{leaflet}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{addProviderTiles}\NormalTok{(providers}\OperatorTok{$}\NormalTok{Esri.WorldImagery) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{fitBounds}\NormalTok{(}\DataTypeTok{lng1 =} \FloatTok{-81.2}\NormalTok{,}
              \DataTypeTok{lng2 =} \FloatTok{-81.1}\NormalTok{,}
              \DataTypeTok{lat1 =} \FloatTok{31.54}\NormalTok{,}
              \DataTypeTok{lat2 =} \FloatTok{31.7}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lat_longs <-}\StringTok{ }\NormalTok{addresses }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{geocode}\NormalTok{(addr, }\DataTypeTok{method =} \StringTok{'osm'}\NormalTok{, }\DataTypeTok{lat =}\NormalTok{ latitude , }\DataTypeTok{long =}\NormalTok{ longitude)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  name        addr                                     latitude longitude}
  \OperatorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{       }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{                                       }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{     }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}
\DecValTok{1}\NormalTok{ White House }\DecValTok{1600}\NormalTok{ Pennsylvania Ave NW, Washington, DC     }\FloatTok{38.9}     \FloatTok{-77.0}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{leaflet}\NormalTok{(}\DataTypeTok{data=}\NormalTok{lat_longs) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{addProviderTiles}\NormalTok{(providers}\OperatorTok{$}\NormalTok{Stamen.Watercolor) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{addMarkers}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{lat_longs <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{latitude=}\FloatTok{48.8584}\NormalTok{, }
                        \DataTypeTok{longitude=}\FloatTok{2.2945}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{reverse <-}\StringTok{ }\NormalTok{lat_longs }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{reverse_geocode}\NormalTok{(}\DataTypeTok{lat =}\NormalTok{ latitude, }
                    \DataTypeTok{long =}\NormalTok{ longitude)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  latitude longitude address                                                    }
     \OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{     }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{                                                      }
\DecValTok{1}     \FloatTok{48.9}      \FloatTok{2.29}\NormalTok{ Tour Eiffel, }\DecValTok{5}\NormalTok{, Avenue Anatole France, Gros}\OperatorTok{-}\NormalTok{Caillou, Quart}\OperatorTok{~}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{leaflet}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{addProviderTiles}\NormalTok{(providers}\OperatorTok{$}\NormalTok{HikeBike.HikeBike) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{addCircleMarkers}\NormalTok{(}\DataTypeTok{data=}\NormalTok{lat_longs, }
                     \DataTypeTok{color =} \StringTok{"firebrick"}\NormalTok{,}
                     \DataTypeTok{radius =} \DecValTok{15}\NormalTok{,}
                     \DataTypeTok{popup =} \KeywordTok{gsub}\NormalTok{(}\StringTok{","}\NormalTok{,}\StringTok{",<br>"}\NormalTok{, reverse}\OperatorTok{$}\NormalTok{address))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ Date[}\DecValTok{1}\OperatorTok{:}\DecValTok{1}\NormalTok{], format}\OperatorTok{:}\StringTok{ "2021-09-25"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{today }\OperatorTok{-}\StringTok{ }\NormalTok{my_birthday}
\NormalTok{Time difference of }\DecValTok{13106}\NormalTok{ days}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{n}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-25 14:30:56 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-25 14:30:57 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-25 09:30:56 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-25"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-26"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-25 19:30:56 UTC"}

\KeywordTok{now}\NormalTok{(}\StringTok{'GMT'}\NormalTok{)}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-25 19:30:56 GMT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-25 19:30:56 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{1632598257}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pkg <-}\StringTok{ 'dplyr'}\NormalTok{     ; }\ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\StringTok{ }\NormalTok{pkg }\OperatorTok{%in%}\StringTok{ }\KeywordTok{installed.packages}\NormalTok{())\{}\KeywordTok{install.packages}\NormalTok{(pkg)\}}
\NormalTok{pkg <-}\StringTok{ 'readr'}\NormalTok{     ; }\ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\StringTok{ }\NormalTok{pkg }\OperatorTok{%in%}\StringTok{ }\KeywordTok{installed.packages}\NormalTok{())\{}\KeywordTok{install.packages}\NormalTok{(pkg)\}}
\NormalTok{pkg <-}\StringTok{ 'ggplot2'}\NormalTok{   ; }\ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\StringTok{ }\NormalTok{pkg }\OperatorTok{%in%}\StringTok{ }\KeywordTok{installed.packages}\NormalTok{())\{}\KeywordTok{install.packages}\NormalTok{(pkg)\}}
\NormalTok{pkg <-}\StringTok{ 'leaflet'}\NormalTok{   ; }\ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\StringTok{ }\NormalTok{pkg }\OperatorTok{%in%}\StringTok{ }\KeywordTok{installed.packages}\NormalTok{())\{}\KeywordTok{install.packages}\NormalTok{(pkg)\}}
\NormalTok{pkg <-}\StringTok{ 'rgdal'}\NormalTok{     ; }\ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\StringTok{ }\NormalTok{pkg }\OperatorTok{%in%}\StringTok{ }\KeywordTok{installed.packages}\NormalTok{())\{}\KeywordTok{install.packages}\NormalTok{(pkg)\}}
\NormalTok{pkg <-}\StringTok{ 'raster'}\NormalTok{    ; }\ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\StringTok{ }\NormalTok{pkg }\OperatorTok{%in%}\StringTok{ }\KeywordTok{installed.packages}\NormalTok{())\{}\KeywordTok{install.packages}\NormalTok{(pkg)\}}
\NormalTok{pkg <-}\StringTok{ 'sp'}\NormalTok{        ; }\ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\StringTok{ }\NormalTok{pkg }\OperatorTok{%in%}\StringTok{ }\KeywordTok{installed.packages}\NormalTok{())\{}\KeywordTok{install.packages}\NormalTok{(pkg)\}}
\NormalTok{pkg <-}\StringTok{ 'rasterVis'}\NormalTok{ ; }\ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\StringTok{ }\NormalTok{pkg }\OperatorTok{%in%}\StringTok{ }\KeywordTok{installed.packages}\NormalTok{())\{}\KeywordTok{install.packages}\NormalTok{(pkg)\}}
\NormalTok{pkg <-}\StringTok{ 'htmltools'}\NormalTok{ ; }\ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\StringTok{ }\NormalTok{pkg }\OperatorTok{%in%}\StringTok{ }\KeywordTok{installed.packages}\NormalTok{())\{}\KeywordTok{install.packages}\NormalTok{(pkg)\}}
\NormalTok{pkg <-}\StringTok{ 'RColorBrewer'} 
                     \ControlFlowTok{if}\NormalTok{(}\OperatorTok{!}\StringTok{ }\NormalTok{pkg }\OperatorTok{%in%}\StringTok{ }\KeywordTok{installed.packages}\NormalTok{())\{}\KeywordTok{install.packages}\NormalTok{(pkg)\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{ccodes}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }\KeywordTok{head}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"/Users/erickeen/repos/intro-to-data-science/USA1_msk_alt.grd"}
\NormalTok{[}\DecValTok{2}\NormalTok{] }\StringTok{"/Users/erickeen/repos/intro-to-data-science/USA2_msk_alt.grd"}
\NormalTok{[}\DecValTok{3}\NormalTok{] }\StringTok{"/Users/erickeen/repos/intro-to-data-science/USA3_msk_alt.grd"}
\NormalTok{[}\DecValTok{4}\NormalTok{] }\StringTok{"/Users/erickeen/repos/intro-to-data-science/USA4_msk_alt.grd"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{coordinates}\NormalTok{(tn) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{head}\NormalTok{()}
\NormalTok{        [,}\DecValTok{1}\NormalTok{]     [,}\DecValTok{2}\NormalTok{]}
\DecValTok{38} \FloatTok{-86.34243} \FloatTok{35.84419}

\KeywordTok{coordinates}\NormalTok{(elevation) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{head}\NormalTok{() }
\NormalTok{          x       y}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pal <-}\StringTok{ }\KeywordTok{colorNumeric}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{"#0C2C84"}\NormalTok{, }\StringTok{"#41B6C4"}\NormalTok{, }\StringTok{"#FFFFCC"}\NormalTok{), }
                    \KeywordTok{values}\NormalTok{(elevation_ll),}
...
\StringTok{  }\KeywordTok{addRasterImage}\NormalTok{(elevation_ll, }
                 \DataTypeTok{colors =}\NormalTok{ pal, }
                 \DataTypeTok{opacity =} \FloatTok{0.8}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{addLegend}\NormalTok{(}\DataTypeTok{pal =}\NormalTok{ pal, }
            \DataTypeTok{values =} \KeywordTok{values}\NormalTok{(elevation_ll),}
            \DataTypeTok{title =} \StringTok{"Elevation (m)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
Source: "/private/tmp/world_small", layer: "TM_WORLD_BORDERS_SIMPL-0.3"
with 246 features
It has 11 fields
...
\CommentTok{# Download the data, if you don't already have it}
...
\DecValTok{2}     \DecValTok{2}\NormalTok{ United Arab Emirates ARE   Middle Eas}\OperatorTok{~}\StringTok{  }\DecValTok{2003}\NormalTok{ BMI, adults     }\FloatTok{26.2}\NormalTok{ BMI            }
...
\DecValTok{4}     \DecValTok{4}\NormalTok{ American Samoa       ASM   East Asia }\OperatorTok{~}\StringTok{  }\DecValTok{2004}\NormalTok{ BMI, adults     }\FloatTok{34.9}\NormalTok{ BMI            }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{leaf <-}\StringTok{ }\KeywordTok{leaflet}\NormalTok{(shp) }\OperatorTok{%>%}\StringTok{ }
\StringTok{           }\KeywordTok{addProviderTiles}\NormalTok{(}\DataTypeTok{provider =}\NormalTok{ providers}\OperatorTok{$}\NormalTok{Esri.WorldShadedRelief)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{map_palette <-}\StringTok{ }\KeywordTok{colorNumeric}\NormalTok{(}\DataTypeTok{palette =} \KeywordTok{brewer.pal}\NormalTok{(}\DecValTok{9}\NormalTok{, }\StringTok{"Greens"}\NormalTok{), }
                            \DataTypeTok{domain=}\NormalTok{shp}\OperatorTok{@}\NormalTok{data}\OperatorTok{$}\NormalTok{value, }
                            \DataTypeTok{na.color=}\StringTok{"#CECECE"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{leaf <-}\StringTok{ }\NormalTok{leaf }\OperatorTok{%>%}\StringTok{ }\KeywordTok{addPolygons}\NormalTok{(}\DataTypeTok{fillColor =} \OperatorTok{~}\KeywordTok{map_palette}\NormalTok{(value),}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{leaf <-}\StringTok{ }\NormalTok{leaf }\OperatorTok{%>%}\StringTok{ }\KeywordTok{addLegend}\NormalTok{(}\DataTypeTok{pal=}\NormalTok{map_palette, }
                           \DataTypeTok{values=}\OperatorTok{~}\NormalTok{value, }
                           \DataTypeTok{opacity=}\FloatTok{0.9}\NormalTok{, }
                           \DataTypeTok{position =} \StringTok{"bottomleft"}\NormalTok{, }
                           \DataTypeTok{na.label =} \StringTok{"NA"}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{leaf <-}\StringTok{ }\NormalTok{leaf }\OperatorTok{%>%}
...
\NormalTok{  nulli <-}\StringTok{ }\KeywordTok{association_tally}\NormalTok{(hw_null,}\DataTypeTok{A=}\StringTok{"59"}\NormalTok{,}\DataTypeTok{B=}\StringTok{"11"}\NormalTok{)}
...
\KeywordTok{hist}\NormalTok{(nulls,}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{20}\NormalTok{,}\DataTypeTok{by=}\DecValTok{1}\NormalTok{),}\DataTypeTok{xlim=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,(obs}\OperatorTok{+}\DecValTok{7}\NormalTok{)),}
     \DataTypeTok{main=}\OtherTok{NULL}\NormalTok{,}\DataTypeTok{xlab=}\StringTok{"Null distribution"}\NormalTok{)}
\KeywordTok{abline}\NormalTok{(}\DataTypeTok{v=}\NormalTok{obs,}\DataTypeTok{lwd=}\DecValTok{2}\NormalTok{,}\DataTypeTok{lty=}\DecValTok{3}\NormalTok{,}\DataTypeTok{col=}\StringTok{"blue"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  counts <-}\StringTok{ }\KeywordTok{table}\NormalTok{(bnf}\OperatorTok{$}\NormalTok{id,bnf}\OperatorTok{$}\NormalTok{year) }
  \CommentTok{# years seen for each individual}
\NormalTok{  n_bnf <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(counts,}\DecValTok{1}\NormalTok{,}\ControlFlowTok{function}\NormalTok{(x)\{}\KeywordTok{length}\NormalTok{(}\KeywordTok{which}\NormalTok{(x}\OperatorTok{>}\DecValTok{0}\NormalTok{))\})}
  
  \CommentTok{# sightings of each whale (rows) in each year (columns)}
\NormalTok{  counts <-}\StringTok{ }\KeywordTok{table}\NormalTok{(other}\OperatorTok{$}\NormalTok{id,other}\OperatorTok{$}\NormalTok{year) }
  
  \CommentTok{# years seen for each individual}
\NormalTok{  n_other <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(counts,}\DecValTok{1}\NormalTok{,}\ControlFlowTok{function}\NormalTok{(x)\{}\KeywordTok{length}\NormalTok{(}\KeywordTok{which}\NormalTok{(x}\OperatorTok{>}\DecValTok{0}\NormalTok{))\}) }
...
\KeywordTok{hist}\NormalTok{(nulls}\OperatorTok{$}\NormalTok{r,}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DataTypeTok{by=}\NormalTok{.}\DecValTok{001}\NormalTok{),}\DataTypeTok{xlim=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,.}\DecValTok{1}\NormalTok{),}
     \DataTypeTok{main=}\OtherTok{NULL}\NormalTok{,}\DataTypeTok{xlab=}\StringTok{"Null distribution"}\NormalTok{,}\DataTypeTok{border=}\StringTok{"grey70"}\NormalTok{)}
...
\NormalTok{  bnfs <-}\StringTok{ }\KeywordTok{expand.grid}\NormalTok{(bnf_ids,bnf_ids) }
  \CommentTok{# Get number of times seen}
\NormalTok{  bnfs}\OperatorTok{$}\NormalTok{X <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(bnfs,}\DecValTok{1}\NormalTok{,social_X) }
...
\CommentTok{# Visualize}
\KeywordTok{par}\NormalTok{(}\DataTypeTok{mar=}\KeywordTok{c}\NormalTok{(}\FloatTok{4.2}\NormalTok{,}\FloatTok{4.2}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\KeywordTok{hist}\NormalTok{(nulls,}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\OperatorTok{-}\DecValTok{6}\NormalTok{,}\DecValTok{6}\NormalTok{,}\DataTypeTok{by=}\NormalTok{.}\DecValTok{1}\NormalTok{),}\DataTypeTok{xlim=}\KeywordTok{c}\NormalTok{(}\OperatorTok{-}\DecValTok{3}\NormalTok{,}\DecValTok{1}\NormalTok{),}
     \DataTypeTok{main=}\OtherTok{NULL}\NormalTok{,}\DataTypeTok{xlab=}\StringTok{"Null distribution"}\NormalTok{)}
\KeywordTok{abline}\NormalTok{(}\DataTypeTok{v=}\NormalTok{obs,}\DataTypeTok{lwd=}\DecValTok{2}\NormalTok{,}\DataTypeTok{lty=}\DecValTok{3}\NormalTok{,}\DataTypeTok{col=}\StringTok{"blue"}\NormalTok{)}
...
\KeywordTok{hist}\NormalTok{(nulls}\OperatorTok{$}\NormalTok{r,}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DataTypeTok{by=}\NormalTok{.}\DecValTok{0001}\NormalTok{),}\DataTypeTok{xlim=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,.}\DecValTok{01}\NormalTok{)}
\NormalTok{     ,}\DataTypeTok{main=}\OtherTok{NULL}\NormalTok{,}\DataTypeTok{xlab=}\StringTok{"Null distribution"}\NormalTok{,}\DataTypeTok{border=}\StringTok{"grey70"}\NormalTok{)}
\KeywordTok{text}\NormalTok{(.}\DecValTok{06}\NormalTok{,}\DecValTok{20}\NormalTok{,}\StringTok{"Correlation }\CharTok{\textbackslash{}n}\StringTok{coefficient"}\NormalTok{,}\DataTypeTok{pos=}\DecValTok{4}\NormalTok{)}
\KeywordTok{abline}\NormalTok{(}\DataTypeTok{v=}\NormalTok{obs[}\DecValTok{2}\NormalTok{],}\DataTypeTok{lwd=}\DecValTok{2}\NormalTok{,}\DataTypeTok{lty=}\DecValTok{3}\NormalTok{,}\DataTypeTok{col=}\StringTok{"blue"}\NormalTok{)}
...
\CommentTok{# > 95% of outcomes expected under the null distribution? }
