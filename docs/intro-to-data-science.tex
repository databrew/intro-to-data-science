...
For example, \texttt{super\_data.rds} contains a \texttt{tibble} version of the dataframe above. When you read in that \texttt{.rds} file, it is already formatted as a \texttt{tibble}:
...
This indicates that the chance that the slope is lower than the null expectation is 89.9\%.
...
\includegraphics{figures/unnamed-chunk-291-1.pdf}
