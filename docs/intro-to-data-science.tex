...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{0.1956277} \FloatTok{9.9649557}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  [}\DecValTok{1}\NormalTok{] }\OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE}  \OtherTok{TRUE} \OtherTok{FALSE} \OtherTok{FALSE}
...
\NormalTok{ [}\DecValTok{25}\NormalTok{] }\OtherTok{FALSE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE}
\NormalTok{ [}\DecValTok{37}\NormalTok{] }\OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE}
\NormalTok{ [}\DecValTok{49}\NormalTok{] }\OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE}
\NormalTok{ [}\DecValTok{61}\NormalTok{] }\OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE}  \OtherTok{TRUE} \OtherTok{FALSE}
\NormalTok{ [}\DecValTok{73}\NormalTok{] }\OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE}  \OtherTok{TRUE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}
\NormalTok{ [}\DecValTok{85}\NormalTok{] }\OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE}
\NormalTok{ [}\DecValTok{97}\NormalTok{] }\OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE} \OtherTok{FALSE}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FloatTok{9.406671} \FloatTok{9.622226} \FloatTok{9.435530} \FloatTok{9.964956} \FloatTok{9.003062} \FloatTok{9.093556} \FloatTok{9.924560} \FloatTok{9.494737}
\NormalTok{ [}\DecValTok{9}\NormalTok{] }\FloatTok{9.077219} \FloatTok{9.781777}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{y[verdicts]}
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\FloatTok{7.454436} \FloatTok{8.224950} \FloatTok{7.799275} \FloatTok{7.326648} \FloatTok{8.022585} \FloatTok{8.909605} \FloatTok{7.209397} \FloatTok{8.339209}
\NormalTok{ [}\DecValTok{9}\NormalTok{] }\FloatTok{7.830558} \FloatTok{8.380138} \FloatTok{8.312140} \FloatTok{8.494822} \FloatTok{8.710897} \FloatTok{7.299667} \FloatTok{7.874331} \FloatTok{8.874041}
\NormalTok{[}\DecValTok{17}\NormalTok{] }\FloatTok{7.631556} \FloatTok{7.819588}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"L<5O]>h2&j=m)}\CharTok{\textbackslash{}"}\StringTok{bv+[PrJe~3"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"k+lJFL~@U(TMO9on4`Ei-Kqf"}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{dataframes-intro}{%
\chapter{Dataframes: Intro}\label{dataframes-intro}}
...
\chapter{Dataframes: Mastery}\label{dataframes}}
...
\includegraphics{figures/unnamed-chunk-261-2.pdf}
...
\includegraphics{figures/unnamed-chunk-362-1.pdf}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{,]   }\DecValTok{69}   \DecValTok{61}   \DecValTok{44}   \DecValTok{42}   \DecValTok{54}   \DecValTok{63}   \DecValTok{56}   \DecValTok{40}   \DecValTok{46}    \DecValTok{52}
\NormalTok{ [}\DecValTok{2}\NormalTok{,]   }\DecValTok{62}   \DecValTok{54}   \DecValTok{63}   \DecValTok{67}   \DecValTok{56}   \DecValTok{50}   \DecValTok{61}   \DecValTok{56}   \DecValTok{62}    \DecValTok{46}
\NormalTok{ [}\DecValTok{3}\NormalTok{,]   }\DecValTok{49}   \DecValTok{47}   \DecValTok{47}   \DecValTok{51}   \DecValTok{72}   \DecValTok{46}   \DecValTok{38}   \DecValTok{53}   \DecValTok{61}    \DecValTok{70}
\NormalTok{ [}\DecValTok{4}\NormalTok{,]   }\DecValTok{48}   \DecValTok{29}   \DecValTok{42}   \DecValTok{29}   \DecValTok{51}   \DecValTok{51}   \DecValTok{60}   \DecValTok{50}   \DecValTok{47}    \DecValTok{59}
\NormalTok{ [}\DecValTok{5}\NormalTok{,]   }\DecValTok{39}   \DecValTok{60}   \DecValTok{49}   \DecValTok{40}   \DecValTok{52}   \DecValTok{35}   \DecValTok{40}   \DecValTok{63}   \DecValTok{45}    \DecValTok{43}
\NormalTok{ [}\DecValTok{6}\NormalTok{,]   }\DecValTok{46}   \DecValTok{61}   \DecValTok{52}   \DecValTok{63}   \DecValTok{46}   \DecValTok{50}   \DecValTok{51}   \DecValTok{50}   \DecValTok{60}    \DecValTok{48}
\NormalTok{ [}\DecValTok{7}\NormalTok{,]   }\DecValTok{50}   \DecValTok{36}   \DecValTok{66}   \DecValTok{46}   \DecValTok{59}   \DecValTok{50}   \DecValTok{56}   \DecValTok{42}   \DecValTok{56}    \DecValTok{45}
\NormalTok{ [}\DecValTok{8}\NormalTok{,]   }\DecValTok{57}   \DecValTok{56}   \DecValTok{66}   \DecValTok{44}   \DecValTok{41}   \DecValTok{53}   \DecValTok{49}   \DecValTok{46}   \DecValTok{57}    \DecValTok{50}
\NormalTok{ [}\DecValTok{9}\NormalTok{,]   }\DecValTok{48}   \DecValTok{60}   \DecValTok{43}   \DecValTok{51}   \DecValTok{49}   \DecValTok{51}   \DecValTok{65}   \DecValTok{31}   \DecValTok{53}    \DecValTok{56}
\NormalTok{[}\DecValTok{10}\NormalTok{,]   }\DecValTok{59}   \DecValTok{57}   \DecValTok{44}   \DecValTok{60}   \DecValTok{50}   \DecValTok{60}   \DecValTok{40}   \DecValTok{46}   \DecValTok{73}    \DecValTok{44}
\KeywordTok{heatmap}\NormalTok{(mx,}\DataTypeTok{Rowv=}\OtherTok{NA}\NormalTok{,}\DataTypeTok{Colv=}\OtherTok{NA}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{figures/unnamed-chunk-414-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# First combine samples into a single dataframe}
\NormalTok{df1 <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{franchise=}\DecValTok{1}\NormalTok{, }\DataTypeTok{fries=}\NormalTok{sample1)}
\NormalTok{df2 <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{franchise=}\DecValTok{2}\NormalTok{, }\DataTypeTok{fries=}\NormalTok{sample2)}
\NormalTok{df3 <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{franchise=}\DecValTok{3}\NormalTok{, }\DataTypeTok{fries=}\NormalTok{sample3)}
\NormalTok{df_all <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(df1,df2,df3)}

\CommentTok{# Make sure `franchise` is treated as a categorical variable, i.e., a factor}
\NormalTok{my_ANOVA <-}\StringTok{ }\KeywordTok{aov}\NormalTok{(fries }\OperatorTok{~}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(franchise), }\DataTypeTok{data=}\NormalTok{df_all)}
\KeywordTok{summary}\NormalTok{(my_ANOVA)}
\NormalTok{                      Df Sum Sq Mean Sq F value    }\KeywordTok{Pr}\NormalTok{(}\OperatorTok{>}\NormalTok{F)    }
\KeywordTok{as.factor}\NormalTok{(franchise)   }\DecValTok{2}  \FloatTok{0.592} \FloatTok{0.29581}   \FloatTok{10.51} \FloatTok{0.0000542} \OperatorTok{**}\ErrorTok{*}
\NormalTok{Residuals            }\DecValTok{147}  \FloatTok{4.138} \FloatTok{0.02815}                      
\OperatorTok{---}
\NormalTok{Signif. codes}\OperatorTok{:}\StringTok{  }\DecValTok{0} \StringTok{'***'} \FloatTok{0.001} \StringTok{'**'} \FloatTok{0.01} \StringTok{'*'} \FloatTok{0.05} \StringTok{'.'} \FloatTok{0.1} \StringTok{' '} \DecValTok{1}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{figures/unnamed-chunk-450-1.pdf}
...
\includegraphics{figures/unnamed-chunk-452-1.pdf}
...
\includegraphics{figures/unnamed-chunk-476-1.pdf}
...
\includegraphics{figures/unnamed-chunk-486-1.pdf}
...
\includegraphics{figures/unnamed-chunk-489-1.pdf}
...
\includegraphics{figures/unnamed-chunk-494-1.pdf}
...
\includegraphics{figures/unnamed-chunk-498-1.pdf}
...
\includegraphics{figures/unnamed-chunk-533-1.pdf}
