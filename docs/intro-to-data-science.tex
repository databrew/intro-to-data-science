...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{player <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"LeBron"}\NormalTok{,}\StringTok{"Mugsy"}\NormalTok{,}\StringTok{"Shaq"}\NormalTok{,}\StringTok{"Jordan"}\NormalTok{,}\StringTok{"Hakeem"}\NormalTok{,}\StringTok{"Kobe"}\NormalTok{)}
\NormalTok{worth <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{500}\NormalTok{, }\DecValTok{14}\NormalTok{, }\DecValTok{400}\NormalTok{, }\DecValTok{1600}\NormalTok{, }\DecValTok{200}\NormalTok{, }\DecValTok{600}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{player <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Jordan"}\NormalTok{,}\StringTok{"Shaq"}\NormalTok{,}\StringTok{"Magic"}\NormalTok{,}\StringTok{"Hakeem"}\NormalTok{,}\StringTok{"Stockton"}\NormalTok{,}\StringTok{"Mugsey"}\NormalTok{)}
\NormalTok{height <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{78}\NormalTok{,}\DecValTok{85}\NormalTok{,}\DecValTok{81}\NormalTok{,}\DecValTok{84}\NormalTok{,}\DecValTok{73}\NormalTok{,}\DecValTok{63}\NormalTok{)}
...
**\texttt{left\_join()**} joins the two datasets together, keeping all rows in the \emph{first} dataframe you feed it.
...
**\texttt{right\_join()**} keeps all rows in the \emph{second} dataframe you feed it:
...
**\texttt{full\_join()**} keeping all rows in \emph{both} dataframes:
...
\textbf{Scenario:} A sailing expedition in 2013 - 2015 studied the whales in the fjords of British Columbia, Canada. That research produced two datasets:
...
[109] 20150614101 20150621201 20150621202
\end{verbatim}
...
[505] 20150920509 20150921501 20150921502 20150921503
\end{verbatim}

Also note that \emph{some} ids -- but not all -- can be found in \emph{both} dataframes. These are the encounters for which we have both foraging behavior data as well as environmental data.
...
A total of \emph{} whale encounters were recorded on \emph{} separate days in the years \emph{} - \emph{}. \emph{} encounters were with humpback whales (\emph{} \% of all encounters), and \emph{} were with fin whales (\emph{} \%). Foraging behavior was recorded in \emph{} \% of encounters (\emph{} \% of humpback whale encounters, and \emph{} \% of fin whale encounters).
...
This indicates that the chance that the slope is lower than the null expectation is 89.6\%.
...
This indicates that the observed regression is better than 80.5\% of scenarios that might be expected under the null expectation.
