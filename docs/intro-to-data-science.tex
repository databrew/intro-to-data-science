...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{4} \DecValTok{2} \DecValTok{3}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{]   }\DecValTok{9} \DecValTok{990}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  [}\DecValTok{1}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}
\NormalTok{ [}\DecValTok{13}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}
\NormalTok{ [}\DecValTok{25}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}
\NormalTok{ [}\DecValTok{37}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}
\NormalTok{ [}\DecValTok{49}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}
...
\NormalTok{ [}\DecValTok{85}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\DecValTok{126} \DecValTok{932} \DecValTok{139} \DecValTok{628} \DecValTok{266} \DecValTok{353} \DecValTok{882} \DecValTok{925} \DecValTok{754} \DecValTok{148} \DecValTok{362} \DecValTok{376} \DecValTok{927} \DecValTok{374} \DecValTok{980} \DecValTok{122} \DecValTok{990} \DecValTok{655} \DecValTok{383}
\NormalTok{[}\DecValTok{20}\NormalTok{] }\DecValTok{249} \DecValTok{332} \DecValTok{224} \DecValTok{900} \DecValTok{963} \DecValTok{780} \DecValTok{217} \DecValTok{268} \DecValTok{471} \DecValTok{586} \DecValTok{462} \DecValTok{924} \DecValTok{212} \DecValTok{377} \DecValTok{121} \DecValTok{513} \DecValTok{670} \DecValTok{881} \DecValTok{146}
\NormalTok{[}\DecValTok{39}\NormalTok{] }\DecValTok{271} \DecValTok{446} \DecValTok{765} \DecValTok{264} \DecValTok{734} \DecValTok{189} \DecValTok{242} \DecValTok{194} \DecValTok{805} \DecValTok{661} \DecValTok{367} \DecValTok{458} \DecValTok{543} \DecValTok{158} \DecValTok{211} \DecValTok{193} \DecValTok{192} \DecValTok{451} \DecValTok{918}
\NormalTok{[}\DecValTok{58}\NormalTok{] }\DecValTok{697} \DecValTok{445} \DecValTok{473} \DecValTok{983} \DecValTok{604} \DecValTok{250} \DecValTok{802} \DecValTok{928} \DecValTok{338} \DecValTok{936} \DecValTok{401} \DecValTok{920} \DecValTok{878} \DecValTok{978} \DecValTok{665} \DecValTok{811} \DecValTok{169} \DecValTok{672} \DecValTok{981}
\NormalTok{[}\DecValTok{77}\NormalTok{] }\DecValTok{769} \DecValTok{841} \DecValTok{975} \DecValTok{761} \DecValTok{100} \DecValTok{822} \DecValTok{411} \DecValTok{152} \DecValTok{491} \DecValTok{664} \DecValTok{703}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{y[verdicts]}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{83} \DecValTok{75} \DecValTok{88}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{">}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{3&-V*F8md=;fP9[XN_\}qGe"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"kqt[e>^X:.i &PGsg?%r4;,I"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ Date[}\DecValTok{1}\OperatorTok{:}\DecValTok{1}\NormalTok{], format}\OperatorTok{:}\StringTok{ "2021-09-12"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{today }\OperatorTok{-}\StringTok{ }\NormalTok{my_birthday}
\NormalTok{Time difference of }\DecValTok{13093}\NormalTok{ days}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{n}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-12 19:53:31 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-12 19:53:32 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-12 14:53:31 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-12"}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{figures/unnamed-chunk-492-1.pdf}
...
\includegraphics{figures/unnamed-chunk-541-1.pdf}
...
\includegraphics{figures/unnamed-chunk-555-1.pdf}
...
\includegraphics{figures/unnamed-chunk-580-1.pdf}
...
\includegraphics{figures/unnamed-chunk-581-1.pdf}
...
\includegraphics{figures/unnamed-chunk-608-1.pdf}
...
\includegraphics{figures/unnamed-chunk-622-1.pdf}
...
\includegraphics{figures/unnamed-chunk-623-1.pdf}
