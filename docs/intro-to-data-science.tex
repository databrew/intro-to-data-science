...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"\&}\SpecialCharTok{\textbackslash{}"}\StringTok{7I,bTcEDmdkUh:sf5\textasciitilde{}\#qY\textquotesingle{}"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"g!VYspQh9icK}\SpecialCharTok{\textbackslash{}"}\StringTok{=$@n LB0\^{}:d"}
\end{Highlighting}
\end{Shaded}
