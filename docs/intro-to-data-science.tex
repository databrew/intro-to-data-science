...
\hypertarget{the-stringr-package}{%
\subsection*{\texorpdfstring{The \texttt{stringr} package}{The stringr package}}\label{the-stringr-package}}
\addcontentsline{toc}{subsection}{The \texttt{stringr} package}
...
This can be particularly useful if you are trying to avoid problems caused by factors. One common issue occurs when \texttt{R} mistakes a set of numbers as a set of factors. Using \texttt{as.character()} can set things right:
...
\textbf{\texttt{paste()}} and \textbf{\texttt{paste0()}}: description:

\textbf{\texttt{tolower()}} and \textbf{\texttt{toupper()}}: description:

\textbf{\texttt{nchar()}}: description:

\textbf{\texttt{substr()}}: description:

\textbf{\texttt{grep()}}: description:

\textbf{\texttt{gsub()}}: description:

\textbf{\texttt{stringr::str\_pad()}}: description:

\textbf{\texttt{str\_split()}}: description:
