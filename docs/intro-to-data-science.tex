...
This indicates that the chance that the slope is lower than the null expectation is 89.7\%.
...
This indicates that the observed regression is better than 79.2\% of scenarios that might be expected under the null expectation.
