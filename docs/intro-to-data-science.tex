...
Your team has to choose between (1) not distributing the medicine at all, (2) only distributing it to men, or (3) some as-yet-unknown solution. What do you do?
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{5} \DecValTok{7} \DecValTok{2}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{]   }\DecValTok{1} \DecValTok{988}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  [}\DecValTok{1}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}
...
\NormalTok{ [}\DecValTok{25}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}
\NormalTok{ [}\DecValTok{37}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}
...
\NormalTok{ [}\DecValTok{61}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE} \OtherTok{FALSE}
\NormalTok{ [}\DecValTok{73}\NormalTok{]  }\OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\DecValTok{898} \DecValTok{655} \DecValTok{480} \DecValTok{456} \DecValTok{883} \DecValTok{125} \DecValTok{453} \DecValTok{660} \DecValTok{672} \DecValTok{985} \DecValTok{476} \DecValTok{287} \DecValTok{332} \DecValTok{381} \DecValTok{276} \DecValTok{815} \DecValTok{757} \DecValTok{951} \DecValTok{766}
\NormalTok{[}\DecValTok{20}\NormalTok{] }\DecValTok{211} \DecValTok{703} \DecValTok{652} \DecValTok{520} \DecValTok{353} \DecValTok{973} \DecValTok{352} \DecValTok{810} \DecValTok{359} \DecValTok{267} \DecValTok{440} \DecValTok{725} \DecValTok{348} \DecValTok{745} \DecValTok{117} \DecValTok{753} \DecValTok{134} \DecValTok{728} \DecValTok{717}
\NormalTok{[}\DecValTok{39}\NormalTok{] }\DecValTok{250} \DecValTok{818} \DecValTok{278} \DecValTok{889} \DecValTok{799} \DecValTok{931} \DecValTok{309} \DecValTok{739} \DecValTok{526} \DecValTok{927} \DecValTok{116} \DecValTok{967} \DecValTok{966} \DecValTok{521} \DecValTok{533} \DecValTok{684} \DecValTok{582} \DecValTok{106} \DecValTok{375}
\NormalTok{[}\DecValTok{58}\NormalTok{] }\DecValTok{606} \DecValTok{255} \DecValTok{700} \DecValTok{988} \DecValTok{704} \DecValTok{830} \DecValTok{400} \DecValTok{363} \DecValTok{444} \DecValTok{635} \DecValTok{915} \DecValTok{445} \DecValTok{279} \DecValTok{147} \DecValTok{692} \DecValTok{894} \DecValTok{870} \DecValTok{259} \DecValTok{756}
\NormalTok{[}\DecValTok{77}\NormalTok{] }\DecValTok{868} \DecValTok{612} \DecValTok{860} \DecValTok{135} \DecValTok{194}  \DecValTok{91} \DecValTok{132} \DecValTok{527} \DecValTok{380} \DecValTok{609} \DecValTok{782} \DecValTok{130} \DecValTok{199} \DecValTok{598}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{y[verdicts]}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{80} \DecValTok{82}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"yx6F>mLC*%j?G4JoBM wKv3Q"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"~yfAL(}\CharTok{\textbackslash{}"}\StringTok{=\{G]JV.|>v^edWq?,"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ Date[}\DecValTok{1}\OperatorTok{:}\DecValTok{1}\NormalTok{], format}\OperatorTok{:}\StringTok{ "2021-09-07"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{today }\OperatorTok{-}\StringTok{ }\NormalTok{my_birthday}
\NormalTok{Time difference of }\DecValTok{13088}\NormalTok{ days}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{n}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-07 18:05:08 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-07 18:05:09 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-07 13:05:08 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-07"}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{figures/unnamed-chunk-536-1.pdf}
