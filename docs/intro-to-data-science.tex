...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"D:Fu[ v04lz\textasciitilde{}kZQ(qrh\textquotesingle{}+a9E"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"MQ;,Zmv=}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{\}Jx\textasciitilde{}ca\textless{}p j:6!/G"}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(readr)}
\NormalTok{health }\OtherTok{\textless{}{-}} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{\textquotesingle{}https://github.com/ZeningQu/World{-}Bank{-}Data{-}by{-}Indicators/raw/master/health/health.csv\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{figures/unnamed-chunk-408-1.pdf}
