...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"P!AlxG?:J@4|TQ\textquotesingle{}y[K.*et0\_"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"fQnT,\textless{}E}\SpecialCharTok{\textbackslash{}"}\StringTok{WF|\}$7*\%VwMk?\&Ya"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{6.164414}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{figures/unnamed-chunk-413-1.pdf}
