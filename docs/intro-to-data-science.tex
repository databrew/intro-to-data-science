...
As with most modules, we recommend\ldots{}
(1) using this module as lecture notes as you manually type each command into a blank RStudio window on a screen you are sharing with the students;
(2) inviting the students to follow along with you, writing the code into RStudio themselves on their own computers; and
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{10}  \DecValTok{4}  \DecValTok{9}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{]   }\DecValTok{6} \DecValTok{988}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  [}\DecValTok{1}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}
\NormalTok{ [}\DecValTok{13}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}
...
\NormalTok{ [}\DecValTok{37}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}
...
\NormalTok{ [}\DecValTok{61}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}
\NormalTok{ [}\DecValTok{73}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}
\NormalTok{ [}\DecValTok{85}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\DecValTok{791} \DecValTok{550} \DecValTok{158} \DecValTok{853} \DecValTok{653} \DecValTok{484} \DecValTok{894} \DecValTok{957} \DecValTok{657} \DecValTok{615} \DecValTok{534} \DecValTok{433} \DecValTok{437} \DecValTok{128} \DecValTok{175} \DecValTok{206} \DecValTok{347} \DecValTok{716} \DecValTok{202}
\NormalTok{[}\DecValTok{20}\NormalTok{] }\DecValTok{930} \DecValTok{606} \DecValTok{179} \DecValTok{642} \DecValTok{199} \DecValTok{325} \DecValTok{360} \DecValTok{841} \DecValTok{662} \DecValTok{600} \DecValTok{892} \DecValTok{270} \DecValTok{646} \DecValTok{747} \DecValTok{988} \DecValTok{711} \DecValTok{193} \DecValTok{483} \DecValTok{713}
\NormalTok{[}\DecValTok{39}\NormalTok{] }\DecValTok{478} \DecValTok{432} \DecValTok{802} \DecValTok{661} \DecValTok{556} \DecValTok{122} \DecValTok{946} \DecValTok{232} \DecValTok{445} \DecValTok{918} \DecValTok{364} \DecValTok{619} \DecValTok{124} \DecValTok{676} \DecValTok{548} \DecValTok{229} \DecValTok{679} \DecValTok{218} \DecValTok{188}
\NormalTok{[}\DecValTok{58}\NormalTok{] }\DecValTok{337} \DecValTok{372} \DecValTok{613} \DecValTok{648} \DecValTok{426} \DecValTok{106} \DecValTok{139} \DecValTok{443} \DecValTok{899} \DecValTok{209} \DecValTok{962} \DecValTok{341} \DecValTok{776} \DecValTok{233} \DecValTok{312} \DecValTok{143} \DecValTok{317} \DecValTok{725} \DecValTok{822}
\NormalTok{[}\DecValTok{77}\NormalTok{] }\DecValTok{608} \DecValTok{644} \DecValTok{610} \DecValTok{768} \DecValTok{540} \DecValTok{318} \DecValTok{450} \DecValTok{457} \DecValTok{773} \DecValTok{677} \DecValTok{291} \DecValTok{485} \DecValTok{885} \DecValTok{293} \DecValTok{821}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{y[verdicts]}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{79} \DecValTok{82}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"ZYh?8OFu j'EV)RgINvDw/n6"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"FYGix*K89U[qjTt>!3`o-zm@"}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{figures/unnamed-chunk-205-2.pdf}
...
\includegraphics{figures/unnamed-chunk-264-2.pdf}
...
\includegraphics{figures/unnamed-chunk-345-1.pdf}
...
\NormalTok{ Date[}\DecValTok{1}\OperatorTok{:}\DecValTok{1}\NormalTok{], format}\OperatorTok{:}\StringTok{ "2021-08-29"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{today }\OperatorTok{-}\StringTok{ }\NormalTok{my_birthday}
\NormalTok{Time difference of }\DecValTok{13079}\NormalTok{ days}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{n}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-08-29 15:44:48 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-08-29 15:44:49 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-08-29 10:44:48 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{44}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-08-29"}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{figures/unnamed-chunk-466-1.pdf}
...
\includegraphics{figures/unnamed-chunk-484-1.pdf}
...
\includegraphics{figures/unnamed-chunk-491-1.pdf}
...
\includegraphics{figures/unnamed-chunk-569-1.pdf}
...
\includegraphics{figures/unnamed-chunk-588-1.pdf}
...
\includegraphics{figures/unnamed-chunk-596-1.pdf}
...
\includegraphics{figures/unnamed-chunk-610-1.pdf}
