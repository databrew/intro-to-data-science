...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"M5]{-}(t\&f=o\}/qG\%.?Z|sw$C)"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"Rwx\^{}sB$(t*Ml?]j@pu1bE)FS"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{5.830952}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{file\_source }\OtherTok{\textless{}{-}} \StringTok{\textquotesingle{}https://raw.githubusercontent.com/databrew/intro{-}to{-}data{-}science/main/data/sewaneegis.RData\textquotesingle{}}
\FunctionTok{library}\NormalTok{(dplyr)}
\FunctionTok{library}\NormalTok{(rgdal)}
\FunctionTok{library}\NormalTok{(raster)}
\FunctionTok{library}\NormalTok{(sp)}
\NormalTok{destination\_directory }\OtherTok{\textless{}{-}} \StringTok{\textquotesingle{}/tmp\textquotesingle{}}
\NormalTok{destination\_file }\OtherTok{\textless{}{-}} \FunctionTok{file.path}\NormalTok{(destination\_directory, }\StringTok{\textquotesingle{}sewaneegis.RData\textquotesingle{}}\NormalTok{)}
\ControlFlowTok{if}\NormalTok{(}\SpecialCharTok{!}\StringTok{\textquotesingle{}sewaneegis.RData\textquotesingle{}} \SpecialCharTok{\%in\%}\NormalTok{ destination\_directory)\{}
...
\includegraphics{figures/unnamed-chunk-418-1.pdf}
...
\includegraphics{figures/unnamed-chunk-425-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(elevation, }\AttributeTok{add =}\NormalTok{ T)}
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{.local}\NormalTok{(.Object, ...)}\SpecialCharTok{:} 
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{plot}\NormalTok{(elevation\_ll, }\AttributeTok{add =}\NormalTok{ T)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}elevation\_ll\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{plot}\NormalTok{(elevation\_ll)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}elevation\_ll\textquotesingle{}}\NormalTok{ not found}
\FunctionTok{plot}\NormalTok{(boundary\_ll, }\AttributeTok{add =}\NormalTok{ T)}
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{polypath}\NormalTok{(}\AttributeTok{x =}\NormalTok{ mcrds[, }\DecValTok{1}\NormalTok{], }\AttributeTok{y =}\NormalTok{ mcrds[, }\DecValTok{2}\NormalTok{], }\AttributeTok{border =}\NormalTok{ border, }\AttributeTok{col =}\NormalTok{ col, }\SpecialCharTok{:}\NormalTok{ plot.new has not been called yet}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
Error in proj4string(domain_elev): object 'domain_elev' not found
\end{verbatim}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{over}\NormalTok{(roads\_ll, }\FunctionTok{polygons}\NormalTok{(boundary\_ll))}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}roads\_ll\textquotesingle{}}\NormalTok{ not found}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{plot}\NormalTok{(domain\_elev)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}domain\_elev\textquotesingle{}}\NormalTok{ not found}
\FunctionTok{plot}\NormalTok{(roads\_ll\_trim, }\AttributeTok{add =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{plot}\NormalTok{(roads\_ll\_trim, }\AttributeTok{add =} \ConstantTok{TRUE}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}roads\_ll\_trim\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ rasterVis}\SpecialCharTok{::}\FunctionTok{contourplot}\NormalTok{(domain\_elev)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}domain\_elev\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in}\NormalTok{ rasterVis}\SpecialCharTok{::}\FunctionTok{levelplot}\NormalTok{(domain\_elev)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}domain\_elev\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{as.data.frame}\NormalTok{(domain\_elev, }\AttributeTok{xy =} \ConstantTok{TRUE}\NormalTok{)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}domain\_elev\textquotesingle{}}\NormalTok{ not found}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ domain\_elev\_df, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ x, }\AttributeTok{y =}\NormalTok{ y, }\AttributeTok{fill =}\NormalTok{ DEM\_USGS\_10m))}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}domain\_elev\_df\textquotesingle{}}\NormalTok{ not found}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Error }\ControlFlowTok{in} \FunctionTok{values}\NormalTok{(elevation\_ll)}\SpecialCharTok{:}\NormalTok{ object }\StringTok{\textquotesingle{}elevation\_ll\textquotesingle{}}\NormalTok{ not found}
...
\includegraphics{figures/unnamed-chunk-465-1.pdf}
...
\includegraphics{figures/unnamed-chunk-470-1.pdf}
...
\includegraphics{figures/unnamed-chunk-475-1.pdf}
