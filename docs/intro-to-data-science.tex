...
So there is indeed a significant difference in the annual site fidelity in the two populations! Bubble net feeders practice higher annual return rates than other whales (p = 0.004).
...
This indicates that the chance that the slope is lower than the null expectation is 89.5\%.
...
This indicates that the observed regression is better than 76.6\% of scenarios that might be expected under the null expectation.
