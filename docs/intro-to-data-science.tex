...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{1} \DecValTok{8} \DecValTok{9}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{]   }\DecValTok{5} \DecValTok{990}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ [}\DecValTok{13}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}
...
\NormalTok{ [}\DecValTok{37}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}
...
\NormalTok{ [}\DecValTok{61}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}
...
\NormalTok{ [}\DecValTok{85}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE} \OtherTok{FALSE}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\DecValTok{522} \DecValTok{478} \DecValTok{430} \DecValTok{231} \DecValTok{600} \DecValTok{841} \DecValTok{749} \DecValTok{272} \DecValTok{858} \DecValTok{918} \DecValTok{488} \DecValTok{628} \DecValTok{195} \DecValTok{802} \DecValTok{441} \DecValTok{220} \DecValTok{648} \DecValTok{313} \DecValTok{812}
\NormalTok{[}\DecValTok{20}\NormalTok{] }\DecValTok{612} \DecValTok{701} \DecValTok{456} \DecValTok{913} \DecValTok{938} \DecValTok{278} \DecValTok{482} \DecValTok{326} \DecValTok{669} \DecValTok{523} \DecValTok{736} \DecValTok{241} \DecValTok{703} \DecValTok{134} \DecValTok{705} \DecValTok{117} \DecValTok{990} \DecValTok{713} \DecValTok{663}
\NormalTok{[}\DecValTok{39}\NormalTok{] }\DecValTok{296} \DecValTok{637} \DecValTok{695} \DecValTok{175} \DecValTok{750} \DecValTok{673} \DecValTok{570} \DecValTok{293} \DecValTok{404} \DecValTok{102} \DecValTok{161} \DecValTok{445} \DecValTok{267} \DecValTok{949} \DecValTok{852} \DecValTok{864} \DecValTok{138} \DecValTok{593} \DecValTok{225}
\NormalTok{[}\DecValTok{58}\NormalTok{] }\DecValTok{115} \DecValTok{893} \DecValTok{230} \DecValTok{892} \DecValTok{470} \DecValTok{849} \DecValTok{611} \DecValTok{466} \DecValTok{953} \DecValTok{582} \DecValTok{513} \DecValTok{643} \DecValTok{509} \DecValTok{508} \DecValTok{407} \DecValTok{959} \DecValTok{379} \DecValTok{635} \DecValTok{720}
\NormalTok{[}\DecValTok{77}\NormalTok{] }\DecValTok{610} \DecValTok{343} \DecValTok{556} \DecValTok{935} \DecValTok{627} \DecValTok{144} \DecValTok{429} \DecValTok{398} \DecValTok{256} \DecValTok{583} \DecValTok{638}  \DecValTok{99} \DecValTok{352} \DecValTok{688}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{y[verdicts]}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{76} \DecValTok{87}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"gs/^xM'na-y\}$ve]&7CH 06Y"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"j AHC9trNL%i#YTwXS=[n\{Z|"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ Date[}\DecValTok{1}\OperatorTok{:}\DecValTok{1}\NormalTok{], format}\OperatorTok{:}\StringTok{ "2021-09-29"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{today }\OperatorTok{-}\StringTok{ }\NormalTok{my_birthday}
\NormalTok{Time difference of }\DecValTok{13110}\NormalTok{ days}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{n}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-29 14:08:46 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-29 14:08:47 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-29 09:08:46 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-29"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-30"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-29 19:08:46 UTC"}

\KeywordTok{now}\NormalTok{(}\StringTok{'GMT'}\NormalTok{)}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-29 19:08:46 GMT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-29 19:08:46 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{1632942526}
