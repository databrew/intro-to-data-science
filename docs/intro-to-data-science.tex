...
\addcontentsline{toc}{chapter}{Types of writing}
...
Your \emph{Methods} section will likely be the thing you write second, immediately after you develop your research question, objectives, and hypotheses.
...
\addcontentsline{toc}{subsubsection}{Common pitfalls}
...
So there is indeed a significant difference in the annual site fidelity in the two populations! Bubble net feeders practice higher annual return rates than other whales (p = 0.005).
...
This indicates that the chance that the slope is lower than the null expectation is 90.2\%.
