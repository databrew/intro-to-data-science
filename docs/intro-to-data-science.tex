...
\textbf{rep()} allows you to repeat a single value a specified number of times:
...
\textbf{sort()} allows you to order a vector from its smallest value to its largest:
...
\textbf{rev()} lets you reverse the order of elements within a vector:
...
\includegraphics{figures/unnamed-chunk-72-1.pdf}
...
\includegraphics{figures/unnamed-chunk-75-1.pdf}
...
\includegraphics{figures/unnamed-chunk-86-1.pdf}
...
\includegraphics{figures/unnamed-chunk-88-1.pdf}
