...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"O6\textquotesingle{}clE?s\{W\textless{}oCQ3\^{}0mK@Aq2{-}"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"r4\&0ys\textasciitilde{}bM@}\SpecialCharTok{\textbackslash{}"}\StringTok{/d }\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{UtgqL\^{}fim"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{        ),}
        ...
        \FunctionTok{mainPanel}\NormalTok{(}
           \FunctionTok{plotOutput}\NormalTok{(}\StringTok{"country\_pop\_plot"}\NormalTok{)}
\NormalTok{        )}
\NormalTok{    )}
\NormalTok{)}
...
\NormalTok{    output}\SpecialCharTok{$}\NormalTok{country\_pop\_plot }\OtherTok{\textless{}{-}} \FunctionTok{renderPlot}\NormalTok{(\{}
...
\hypertarget{add-another-input-for-year}{%
\chapter{add another input (for year)}\label{add-another-input-for-year}}
...
\includegraphics{figures/unnamed-chunk-411-1.pdf}
...
\includegraphics{figures/unnamed-chunk-432-1.pdf}
