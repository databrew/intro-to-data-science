...
This indicates that the chance that the slope is lower than the null expectation is 90\%.
...
This indicates that the observed regression is better than 77.4\% of scenarios that might be expected under the null expectation.
