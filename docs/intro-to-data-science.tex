...
This indicates that the chance that the slope is lower than the null expectation is 87.5\%.
...
This indicates that the observed regression is better than 76.4\% of scenarios that might be expected under the null expectation.
