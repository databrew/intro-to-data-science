...
\item
  The \textbf{Accessing \& managing data} unit teaches you how to organize data for large projects, how to manage atypical data formats (e.g., Excel files), and how to access data from online databases.
\item
...
\item
  The \textbf{Databases} unit teaches you how to access, create, and work with online databases using \texttt{SQL} and its alternatives.
\item
