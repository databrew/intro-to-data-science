...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"Tv)opZW%=\{S}\CharTok{\textbackslash{}"}\StringTok{zciPU<JlKYd$"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{titanic_age <-}\StringTok{ }\NormalTok{titanic }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(Sex) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{mean_age =} \KeywordTok{mean}\NormalTok{(Age, }\DataTypeTok{na.rm=} \OtherTok{TRUE}\NormalTok{))}
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ titanic_age, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ Sex,}\DataTypeTok{y=}\NormalTok{ mean_age)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_bar}\NormalTok{(}\DataTypeTok{stat =} \StringTok{'identity'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{titanic_em <-}\StringTok{ }\NormalTok{titanic }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(Sex, Survived) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{mean_age=} \KeywordTok{mean}\NormalTok{(Age, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{))}
\NormalTok{titanic_em <-}\StringTok{ }\NormalTok{titanic_em }\OperatorTok{%>%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Survived =} \KeywordTok{ifelse}\NormalTok{(Survived }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{, }\StringTok{'Survived'}\NormalTok{,}\StringTok{'Dead'}\NormalTok{ ))}
\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ titanic_em, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Sex, }\DataTypeTok{y=}\NormalTok{mean_age, }\DataTypeTok{fill =}\NormalTok{ Survived)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_bar}\NormalTok{(}\DataTypeTok{stat=}\StringTok{'identity'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{     id make      model     year class trans drive   cyl displ fuel    hwy   cty}
  \OperatorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{     }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{    }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{chr}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}\StringTok{ }\ErrorTok{<}\NormalTok{dbl}\OperatorTok{>}
\DecValTok{1} \DecValTok{33640}\NormalTok{ Chevrolet Spark EV  }\DecValTok{2014}\NormalTok{ Subc}\OperatorTok{~}\StringTok{ }\NormalTok{Auto}\OperatorTok{~}\StringTok{ }\NormalTok{Fron}\OperatorTok{~}\StringTok{    }\OtherTok{NA}    \OtherTok{NA}\NormalTok{ Elec}\OperatorTok{~}\StringTok{   }\DecValTok{109}   \DecValTok{128}
\DecValTok{2} \DecValTok{33396}\NormalTok{ Fiat      500e      }\DecValTok{2013}\NormalTok{ Mini}\OperatorTok{~}\StringTok{ }\NormalTok{Auto}\OperatorTok{~}\StringTok{ }\NormalTok{Fron}\OperatorTok{~}\StringTok{    }\OtherTok{NA}    \OtherTok{NA}\NormalTok{ Elec}\OperatorTok{~}\StringTok{   }\DecValTok{108}   \DecValTok{122}
\DecValTok{3} \DecValTok{34392}\NormalTok{ Fiat      500e      }\DecValTok{2014}\NormalTok{ Mini}\OperatorTok{~}\StringTok{ }\NormalTok{Auto}\OperatorTok{~}\StringTok{ }\NormalTok{Fron}\OperatorTok{~}\StringTok{    }\OtherTok{NA}    \OtherTok{NA}\NormalTok{ Elec}\OperatorTok{~}\StringTok{   }\DecValTok{108}   \DecValTok{122}
\DecValTok{4} \DecValTok{33265}\NormalTok{ Honda     Fit EV    }\DecValTok{2013}\NormalTok{ Smal}\OperatorTok{~}\StringTok{ }\NormalTok{Auto}\OperatorTok{~}\StringTok{ }\NormalTok{Fron}\OperatorTok{~}\StringTok{    }\OtherTok{NA}    \OtherTok{NA}\NormalTok{ Elec}\OperatorTok{~}\StringTok{   }\DecValTok{105}   \DecValTok{132}
...
\NormalTok{men <-}\StringTok{ }\NormalTok{people }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(sex }\OperatorTok{==}\StringTok{ 'Male'}\NormalTok{)}
\NormalTok{women <-}\StringTok{ }\NormalTok{people }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(sex }\OperatorTok{==}\StringTok{ 'Male'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{figures/unnamed-chunk-467-1.pdf}
...
\includegraphics{figures/unnamed-chunk-473-1.pdf}
...
\includegraphics{figures/unnamed-chunk-477-1.pdf}
