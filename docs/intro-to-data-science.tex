...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{6} \DecValTok{4} \DecValTok{3}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{]   }\DecValTok{8} \DecValTok{986}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ [}\DecValTok{13}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}
...
\NormalTok{ [}\DecValTok{37}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}
\NormalTok{ [}\DecValTok{49}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}
\NormalTok{ [}\DecValTok{61}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}
...
\NormalTok{ [}\DecValTok{85}\NormalTok{]  }\OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE} \OtherTok{FALSE}  \OtherTok{TRUE}  \OtherTok{TRUE}  \OtherTok{TRUE}
...
\NormalTok{ [}\DecValTok{1}\NormalTok{] }\DecValTok{323} \DecValTok{927} \DecValTok{702} \DecValTok{638} \DecValTok{366} \DecValTok{160} \DecValTok{363} \DecValTok{890} \DecValTok{713} \DecValTok{966} \DecValTok{133} \DecValTok{773} \DecValTok{872} \DecValTok{914} \DecValTok{307} \DecValTok{986} \DecValTok{433} \DecValTok{830} \DecValTok{658}
\NormalTok{[}\DecValTok{20}\NormalTok{] }\DecValTok{908} \DecValTok{735} \DecValTok{968} \DecValTok{321} \DecValTok{149} \DecValTok{242} \DecValTok{900} \DecValTok{572} \DecValTok{737} \DecValTok{640} \DecValTok{155} \DecValTok{684} \DecValTok{508} \DecValTok{633} \DecValTok{459} \DecValTok{666} \DecValTok{158} \DecValTok{898} \DecValTok{842}
\NormalTok{[}\DecValTok{39}\NormalTok{] }\DecValTok{667} \DecValTok{188} \DecValTok{730} \DecValTok{859} \DecValTok{457} \DecValTok{103} \DecValTok{907} \DecValTok{487} \DecValTok{690} \DecValTok{290} \DecValTok{265} \DecValTok{245} \DecValTok{557} \DecValTok{251} \DecValTok{599} \DecValTok{107} \DecValTok{771} \DecValTok{870} \DecValTok{587}
\NormalTok{[}\DecValTok{58}\NormalTok{] }\DecValTok{228} \DecValTok{311} \DecValTok{868} \DecValTok{159} \DecValTok{179} \DecValTok{502} \DecValTok{802} \DecValTok{628} \DecValTok{803} \DecValTok{911} \DecValTok{212} \DecValTok{691} \DecValTok{453} \DecValTok{175} \DecValTok{420} \DecValTok{860} \DecValTok{706} \DecValTok{981} \DecValTok{843}
\NormalTok{[}\DecValTok{77}\NormalTok{] }\DecValTok{631} \DecValTok{356} \DecValTok{597} \DecValTok{614} \DecValTok{365} \DecValTok{470} \DecValTok{260} \DecValTok{682} \DecValTok{820} \DecValTok{256} \DecValTok{815} \DecValTok{621} \DecValTok{106} \DecValTok{132} \DecValTok{949}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{y[verdicts]}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\DecValTok{78} \DecValTok{74}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"Ef$2n=~B}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{Y(K0-QG%RAJ_)FT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"$jqXb]*K4@%R`FV[/t+|m1wN"}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{figures/unnamed-chunk-210-2.pdf}
...
\NormalTok{ Date[}\DecValTok{1}\OperatorTok{:}\DecValTok{1}\NormalTok{], format}\OperatorTok{:}\StringTok{ "2021-09-05"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{today }\OperatorTok{-}\StringTok{ }\NormalTok{my_birthday}
\NormalTok{Time difference of }\DecValTok{13086}\NormalTok{ days}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{n}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-05 15:16:33 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-05 15:16:34 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-05 10:16:33 CDT"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"2021-09-05"}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{figures/unnamed-chunk-599-1.pdf}
...
\includegraphics{figures/unnamed-chunk-607-1.pdf}
