...
\hypertarget{for-loops-with-data}{%
\section*{\texorpdfstring{\texttt{for} loops with data}{for loops with data}}\label{for-loops-with-data}}
\addcontentsline{toc}{section}{\texttt{for} loops with data}
...
\subsection*{\texorpdfstring{\emph{Nested} \texttt{for} loops}{Nested for loops}}\label{nested-for-loops}}
\addcontentsline{toc}{subsection}{\emph{Nested} \texttt{for} loops}
...
\hypertarget{using-for-loops-to-layer-cyclical-data}{%
\subsection*{\texorpdfstring{Using \texttt{for} loops to layer cyclical data}{Using for loops to layer cyclical data}}\label{using-for-loops-to-layer-cyclical-data}}
\addcontentsline{toc}{subsection}{Using \texttt{for} loops to layer cyclical data}
