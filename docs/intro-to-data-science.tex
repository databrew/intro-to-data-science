...
\hypertarget{style}{%
\chapter{Elements of structure \& style}\label{style}}
...
\addcontentsline{toc}{section}{Talk structure}

\emph{Note: Under construction!}

\hypertarget{speaker-style}{%
\section*{Speaker style}\label{speaker-style}}
\addcontentsline{toc}{section}{Speaker style}

\emph{Note: Under construction!}

\hypertarget{visual-aids}{%
\section*{Visual aids}\label{visual-aids}}
\addcontentsline{toc}{section}{Visual aids}

\emph{Note: Under construction!}

\hypertarget{strategies-4}{%
\section*{Strategies}\label{strategies-4}}
\addcontentsline{toc}{section}{Strategies}
...
So there is indeed a significant difference in the annual site fidelity in the two populations! Bubble net feeders practice higher annual return rates than other whales (p = 0).
...
This indicates that the chance that the slope is lower than the null expectation is 90.7\%.
...
This indicates that the observed regression is better than 79.3\% of scenarios that might be expected under the null expectation.
